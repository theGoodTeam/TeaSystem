...
<form action="/JavaOnlineExamination/Add_examgroup_servlet" method="post"> 
<%
...
<!-- SubPopup -->
<div id="BtmBtn">
<div class="btn_boxB floatR mag_l20"><input name=""  value="取消" type="button"  onmousemove="this.className='input_move'" onmouseout="this.className='input_out'" onclick="window.location.href='tab.jsp';"></div>
