...
<form action="/JavaOnlineExamination/Add_User_Servlet" method="post"> 
...
<input class="select" type="text" style="width:225px;height: 25px;"  name="password">
</div>
<!-- /selectbox --></td>
</tr>
<tr>
<th>&nbsp&nbsp&nbsp类型</th>
<td><!-- selectbox -->
<div class="selectbox" style="width:230px;">
<dl class="select">
<dt>请选择</dt>
<dd><ul>
<li><a href="#"><input type="hidden" name="user_type" value="学生">学生</a></li>
<li><a href="#"><input type="hidden" name="user_type" value="教师">教师</a></li>
