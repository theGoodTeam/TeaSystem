...
<title>管理员管理</title>
 ...
 <link rel="stylesheet" type="text/css" href="/JavaOnlineExamination/all_manage/css/css.css" />
<script type="text/javascript" src="/JavaOnlineExamination/all_manage/js/jquery.min.js"></script>
<!-- <script type="text/javascript" src="/JavaOnlineExamination/all_manage/js/page.js" ></script> -->
</head>
...
<form action="/JavaOnlineExamination/QueryUser_Servlet" method="post">
	<div id="pageAll">
		...
		<div class="page">
			...
			<div class="connoisseur">
				...
				<!-- user 表格 显示 -->
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0" id="t_student">
						<tr>
							<td width="66px" class="tdColor tdC">序号</td>
							<td width="400px" class="tdColor">用户名</td>
							<td width="630px" class="tdColor">用户密码</td>
							<td width="630px" class="tdColor">用户类型</td>
						...
						<%
						 ...
						 %>
							...
							%>
						    <tr height="40px" >
							<td class="SortCLASS" class="id"><%=user.getU_id()%></td>
			...
			<div class="gridItem" style="padding: 5px; width: 250px; float: left; text-align: left; height: 20px; font-size: 15px;" > 
				...
				<div class="bottom" style="margin-top: 25px; width: 60px; height: 40px;"></div>
				<!-- user 表格 显示 end-->
			</div>
			<!-- user页面样式end -->
		</div>
	...
	<div class="banDel">
		<div class="delete">
			<div class="close">
				<a><img src="/JavaOnlineExamination/all_manage/img/shanchu.png" /></a>
			</div>
			<p class="delP1">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp你确定要删除此条记录吗？</p>
			<p class="delP2">
				<a href="#" class="ok yes">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp确定</a><a class="ok no">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp取消</a>
			</p>
		</div>
	</div>
