	...
	<div class="container">
		...
		<div class="leftsidebar_box">
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="img/coin111.png" /><img class="coin22"
						src="img/coin222.png" /><a class="cks" href="goods_list.jsp"
						target="main">商品列表</a><img class="icon5" src="img/coin21.png" />
				</dd>
				<dd>
					<img class="coin11" src="img/coin111.png" /><img class="coin22"
						src="img/coin222.png" /><a class="cks" href="tab.jsp"
						target="main">商品类目</a><img class="icon5" src="img/coin21.png" />
				</dd>
			</dl>
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="img/coin111.png" /><img class="coin22"
						src="img/coin222.png" /><a href="tab.jsp" target="main"
			...
			<dl class="system_log">
				...
				<dd>
					<img class="coin11" src="img/coin111.png" /><img class="coin22"
						src="img/coin222.png" /><a href="exit.jsp" class="cks" target ="_top">退出</a><img
