...
<body class="childrenBody">
	<form class="layui-form" action="addPlayerinfo" method="post">
		...
		<!-- 上传图片:<div class="img" style="display:inline"><input type="file" size="25px" name="goodspic" maxlength="100"></div>  -->
		
		
		<div class="layui-form-item" style="margin-left: 5%;">
		    <div class="layui-input-block">
		        <button type="submit" style="width: 80px;height: 38px; background-color: #1E9FFF;border:none;cursor: pointer;">添加</button>
...
<script>
$(".layui-btn layui-btn-primary").bind('click',function(){
	alert("00");
